.data 
	...
	PI: .float 3.14159                                 # armazenando PI como float na memória
	ZEROf: .float 0.0                                  # armazenando ZEROf como float na memória
...
.text .globl main
		...
		main:
			...
			lwc1 $f31, ZEROf        # carregando o conteúdo de ZEROf para o registrador $f31 (ele terá papel similar ao $zero)
			...
			lwc1 $f12, PI           # carregando o conteúdo de PI para o registrador $f12
