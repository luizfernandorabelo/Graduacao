.data
    ...
    .align 3
        PI: .double 3.14159                                 # armazenando 3.14159 como double na memória
        ZEROlf: .double 0.0                                 # armazenando 0.0 como double na memória

.text
    .globl main
    
    main:
        ldc1 $f30, ZEROlf       # carregando o conteúdo de ZEROlf da memória para os registradores $f30/31 (que terão papel similar ao $zero)
