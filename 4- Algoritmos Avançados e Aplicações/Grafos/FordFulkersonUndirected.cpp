...
int** initializeAdjacencyMatrix(int totalVertices) {
...
int** readAdjacencyMatrix(int totalVertices, int totalEdges) {

    int** adjMatrix = initializeAdjacencyMatrix(totalVertices);
...
int main(void) {
    ...
    for (int i = 1; cin >> totalVertices >> startVertex >> endVertex >> totalEdges; i++) {
        int** adjMatrix = readAdjacencyMatrix(totalVertices, totalEdges);
